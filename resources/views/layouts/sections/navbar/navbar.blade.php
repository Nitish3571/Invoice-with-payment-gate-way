          ...
          <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
              <div class="avatar avatar-online">
                <img src="@if(session("profileImg")){{ asset('img/profile/' . session("profileImg")) }} @else  {{ asset('assets/img/avatars/1.png') }}@endif" alt class="w-px-40 h-px-40 rounded-circle border-1">
                ...
                <a class="dropdown-item" href="javascript:void(0);">
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                      <span class="fw-medium d-block">@if (session('name')) {{session("name")}}  @endif</span>
                      <small class="text-muted">@if (session('email')) {{session("email")}}  @endif</small>
                    </div>
                  </div>
                </a>
              </li>
